...
L["Custom…"]                               = "Custom…"
L["Award %s to %s for \"%s\"?"]            = "Award %s to %s for \"%s\"?"
L["Award %s to %s for:"]                   = "Award %s to %s for:"
L["Award reasons (right-click Award):"]    = "Award reasons (right-click Award):"
L["%d awards"]                             = "%d awards"
L["%d tokens"]                             = "%d tokens"
L["last %s"]                               = "last %s"
...
L["Prio (%s):"]                            = "Prio (%s):"
L["Prio: %s"]                              = "Prio: %s"
L["Meta gem inactive"]                     = "Meta gem inactive"
L["Socket bonus unmet"]                    = "Socket bonus unmet"
...
L["Gbank: %s withdrew %s (synced from %s)."] = "Gbank: %s withdrew %s (synced from %s)."
L["Gbank: %s annotated a transaction."]    = "Gbank: %s annotated a transaction."
L["  …and %d more."]                        = "  …and %d more."
...
L["Loot window background opacity"]         = "Loot window background opacity"
L["Minimap"]                                = "Minimap"
